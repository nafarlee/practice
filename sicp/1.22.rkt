...
; √10 ~= 3.16
; Average time for first trials: 54.7
;                                * 3 = 164.1
; Average time for second trials: 158
;                                 * 3 = 474
; Average time for third trials: 501.33
; This data supports the notion that computation time is roughly
; proportional to the number of steps required.
